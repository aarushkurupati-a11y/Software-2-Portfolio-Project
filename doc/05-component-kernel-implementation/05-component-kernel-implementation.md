...
- Designed kernel implementation for VolleyballRotation component

### Updated

- Changed design to include all kernel methods as well as standard interface kernel methods...
