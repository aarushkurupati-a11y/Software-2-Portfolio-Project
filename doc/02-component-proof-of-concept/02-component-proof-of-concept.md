...
- **Name**: <!-- TODO: fill with first and last name (e.g., Brutus Buckeye) then delete this comment --> Aarush Kurupati
- **Dot Number**: <!-- TODO: fill with OSU dot number (e.g., buckeye.17) then delete this comment --> Kurupati.2
- **Due Date**: <!-- TODO: fill out with due date and time (e.g., 10/17 @ 3:10 PM EST) then delete this comment --> 02/26 @ 12:40 PM EST
...
After considering my designs I decided to move forward with my VolleyballRotation component. VolleyballRotation is structurally simple and very clear. It maintains an ordered group of players and supports controlled rotation. The behavior is easy to reason and the representation can remain straightforward while still properly using kernel implementation and secondary layering. This makes it a strong candidate for a proof-of-concept because I can focus on clean abstraction and disciplined design rather than complicated logic. Also, volleyball is something I personally enjoy, and the structured rotation system translates pretty well into an ordered data structure. Because the rules of rotation are defined, the component’s behavior is easy to specify and test.
...
- Designed a proof of concept for VolleyballRotation component

### Updated

- Changed design to include ...

Kernel methods that may support this component
```
