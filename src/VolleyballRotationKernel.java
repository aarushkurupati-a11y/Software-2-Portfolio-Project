 ...
 * component.
 *
 * @mathmodel ROTATION is modeled by a sequence of PLAYER
 *
 *            where: - the sequence represents the clockwise order of players on
 *            the court - position 0 is the current server position
 */
